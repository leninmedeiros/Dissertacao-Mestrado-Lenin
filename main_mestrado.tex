...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Titulo{Explorando o Compartilhamento de Conteúdo em Redes Sociais para Fomentar a Contribuição \\em Sites de Perguntas e Respostas }
...
\bibliographystyle{abntex2-num} % estilo de bibliografia   plain,unsrt,alpha,abbrv.
